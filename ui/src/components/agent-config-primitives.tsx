...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "에이전트의 실행 워크스페이스 전략. project_primary는 일반 cwd 실행, git_worktree는 이슈별 격리 체크아웃.",
  ...
  bootstrapPrompt: "새 세션 시작 시에만 전송. 매 heartbeat에 반복되지 않는 안정적 설정 가이드에 사용.",
  payloadTemplateJson: "플랫폼이 표준 wake/workspace 필드를 추가하기 전에 원격 어댑터 요청 페이로드에 병합되는 선택적 JSON.",
