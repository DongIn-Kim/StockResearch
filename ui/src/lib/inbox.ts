...
export const DISMISSED_KEY = "sr:inbox:dismissed";
export const READ_ITEMS_KEY = "sr:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "sr:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "sr:inbox:issue-columns";
