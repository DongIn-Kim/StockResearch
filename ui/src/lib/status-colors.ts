...
export const issueStatusIcon: Record<string, string> = {
  ...
  deferred: "text-orange-500 border-orange-500 dark:text-orange-400 dark:border-orange-400",
};
...
export const issueStatusText: Record<string, string> = {
  ...
  deferred: "text-orange-500 dark:text-orange-400",
};
...
export const statusBadge: Record<string, string> = {
  ...
  deferred: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
};
