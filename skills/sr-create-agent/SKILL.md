---
name: sr-create-agent
description: >
  거버넌스 기반 에이전트 생성. 어댑터 설정 옵션 조회, 기존 에이전트 설정 비교,
  새 에이전트 프롬프트/설정 초안 작성, 채용 요청 제출 시 사용.
---

# SR Create Agent Skill
...
`skills/sr-create-agent/references/api-reference.md`
